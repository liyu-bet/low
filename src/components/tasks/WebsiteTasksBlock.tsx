...
import type { WebsiteTasksBlockData, WebsiteOption } from '@/lib/tasks/types';
  ...
  return (
    <section className="space-y-4">
      ...
      <div className="space-y-3">
        <h3 className="text-sm uppercase tracking-wide text-ink-200">Открытые</h3>
