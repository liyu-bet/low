...
export function ReportsSummary({ summary }: { summary: ReportsSummary }) {
  const cards: Card[] = [
    ...
    { label: 'Подключено к GSC', value: summary.withGsc, href: '/dashboard?focus=no_gsc' },
    { label: 'Есть показы', value: summary.withImpressions, href: '/dashboard?focus=no_impressions' },
    { label: 'Есть клики', value: summary.withClicks, href: '/dashboard?focus=no_clicks' },
